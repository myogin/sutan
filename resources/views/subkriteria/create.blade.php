								...
								<div class="row">
									<div class="col-lg-8">
										...
										<div class="card card-custom example example-compact">
											...
											<!--begin::Form-->
											<form class="form" id="kt_form_1" action="{{route('subkriteria.store')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
												<div class="card-body">
                                                    <!--begin::ALLERT-->
                                                    @if(session('status'))
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" value="{{old('subkriteria')}}" class="form-control" name="subkriteria" placeholder="Enter your name" />
														</div>
													</div>
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Nilai *</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="number" value="{{old('nilai')}}" class="form-control" name="nilai" placeholder="Enter your name" />
														</div>
													</div>
												</div>
