			...
			<div class="d-flex flex-row flex-column-fluid page">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item menu-item-submenu  {{ (request()->is('users*')) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <li class="menu-item menu-item-submenu {{ (request()->is('kriteria*')) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('kriteria.create')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Add</span>
                                ...
                                <li class="menu-item menu-item-submenu {{ (request()->is('subkriteria*')) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										<span class="menu-text">Sub Kriteria</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('subkriteria.create')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Add</span>
                                ...
                                <li class="menu-item {{ (request()->is('penilaian*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="header header-fixed">
						<!--begin::Container-->
						<div class="container-fluid align-items-stretch justify-content-between" style="width: 100%;">
							<!--begin::Topbar-->
							<div class="topbar float-right">
								<!--begin::User-->
								<div class="topbar-item" style="padding-top: 10px;">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						...
						<div class="symbol-label" style="background-image: url('{{asset('storage/'.Auth::user()->avatar)}}')"></div>
						 @else
                        <div class="symbol-label" style="background-image: url('{{asset('media/default-user-image.png')}}')"></div>
                        @endif
                        <i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{Auth::user()->name}}</a>
						<div class="text-muted mt-1">{{Auth::user()->Status}}</div>
						<div class="navi mt-2">
