								...
								<div class="card card-custom">
									<div class="card-header">
										...
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="{{route('penilaian.create')}}" class="btn btn-primary font-weight-bolder">
											<span class="svg-icon svg-icon-md">
									...
									<div class="card-body">
										<!--begin: Datatable-->
										<table class="table table-separate table-head-custom  table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
											<thead>
												<tr>
													<th>No</th>
...
@section('js')
		...
		{{-- <script src="{{asset('js/pages/crud/datatables/gabungan.js')}}"></script> --}}
		<!--end::Page Scripts-->
...
function deleteData(id){
    ...
    function editData(id) {
        window.location = "{{ url('subkriteria') }}/" +id+"/edit";
}
