								...
								<div class="row">
									<div class="col-lg-8">
										...
										<div class="card card-custom example example-compact">
											...
											<!--begin::Form-->
											<form class="form" id="kt_form_1" action="{{route('subkriteria.update', ['id'=>$subkriteria->id])}}" method="POST" enctype="multipart/form-data">
                                                @csrf
												...
												<div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                                            <select class="form-control select2" id="kt_select2" name="kriteria">
                                                                <option  label="Label"></option>
                                                                @foreach ($kriteria as $krt)
                                                                <option value="{{$krt->id}}">{{$krt->kriteria}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Sub Kriteria *</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" value="{{old('kriteria') ? old('kriteria') : $subkriteria->sub_kriteria}}" class="form-control" name="subkriteria" placeholder="Enter your name" />
														</div>
													</div>
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Nilai *</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="number" value="{{old('nilai') ? old('nilai') : $subkriteria->nilai}}" class="form-control" name="nilai" placeholder="Enter your name" />
														</div>
													</div>
												</div>
...
@section('js')
    ...
    var KTFormControls = function () {
        ...
        var _initDemo1 = function () {
            ...
            $('.select2').val({{$subkriteria->kriteria_id}}).trigger('change');

            $('#kt_select2').on('change', function(){
                // Revalidate field
                validator.revalidateField('kriteria');
            });
