								...
								<div class="row">
									<div class="col-lg-8">
										...
										<div class="card card-custom example example-compact">
											...
											<!--begin::Form-->
											<form class="form" id="kt_form_1" action="{{route('kriteria.update', ['id'=>$kriteria->id])}}" method="POST" enctype="multipart/form-data">
                                                @csrf
												...
												<div class="card-body">
                                                    ...
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Kriteria *</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" value="{{old('name') ? old('name') : $kriteria->kriteria}}" class="form-control" name="kriteria" placeholder="Enter your name" />
														</div>
													</div>
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Bobot *</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="number" value="{{old('bobot') ? old('bobot') : $kriteria->bobot}}" class="form-control" name="bobot" placeholder="Enter your name" />
														</div>
													</div>
												</div>
